import React from "react";
    ...
    const CartPage = () => {
      ...
      const total = priceDetails.price - priceDetails.discount - priceDetails.buyMoreSave - priceDetails.coupons + priceDetails.delivery;
      const savings = priceDetails.discount + priceDetails.buyMoreSave + priceDetails.coupons;
          ...
          <main className="container mx-auto px-4 py-6 flex flex-col md:flex-row gap-6 flex-1">
            ...
            <section className="md:w-2/3 bg-white rounded-lg shadow-md p-6 relative">
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-gray-800">From Saved Addresses</h2>
                <div>
                  <input 
                    type="text" 
              ...
              <div className="product-list" style={{ 
                ...
                <div className="place-order-fixed" style={{ 
                  position: 'sticky', 
                  bottom: 0, 
                  background: 'white', 
                  padding: '1rem', 
            ...
            <section className="md:w-1/3 flex flex-col">
              <div className="price-details bg-white rounded-lg shadow-md p-6" style={{ position: 'sticky', top: 0 }}>
                <h2 className="text-xl font-bold text-gray-800 mb-4">Price Details</h2>
                <div className="space-y-2">
                  <div className="flex justify-between">
                    <span>Price ({products.filter(p => p.inStock).length} items)</span>
                ...
                <p className="text-green-600 text-sm mt-4">You will save ₹{savings.toLocaleString()} on this order</p>
              </div>
