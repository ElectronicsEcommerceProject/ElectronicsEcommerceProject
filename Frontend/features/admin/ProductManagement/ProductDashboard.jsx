    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-4 sm:p-5 h-full flex flex-col hover:shadow-xl transition-shadow duration-300">
      ...
      <div className="relative mb-4">
        <input
          ...
          className="w-full p-3 pl-10 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-gray-50 hover:bg-white"
        />
