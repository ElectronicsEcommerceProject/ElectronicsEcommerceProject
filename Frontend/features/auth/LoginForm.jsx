  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alertService.showSuccess(
        "Authentication Has Been Successfully Confirmed!"
      );
    ...
    <Container className="min-h-screen flex justify-center items-center">
      <Row className="w-full justify-center py-5">
        <Col xs={12} sm={10} md={6} lg={5}>
          {/* Gradient Border Applied Here */}
          <div
            className="bg-white p-5 shadow-lg rounded-3xl"
            style={{
              position: "relative",
              borderRadius: "15px",
              background: "white",
          ...
          >
            <div
              style={{
                position: "absolute",
                inset: "-2px", // Extend gradient to outer edge
                borderRadius: "17px", // Slightly larger to cover corners
                background: "linear-gradient(45deg, #22C55E, #10B981, #047857)", // Green gradient
                zIndex: "-1", // Place gradient behind content
              }}
            />
